        ...
        <div class="col-12"><!-- col-lg-10 order-1 -->
          ...
          <div class="mt-3">
            <ul class="lista list-inline">
              ...
              ?>
                <li id="<?= $registro->idfuncionario ?>" class="d-flex justify-content-between">
                  ...
                  <div class="d-flex flex-row align-items-center">
                    <div class="d-flex flex-column mr-2">
                      <div class="d-flex flex-row">
                        ...
                        <button class="btn-primary ml-2 align-self-center negrito" onclick="baterPonto(<?= $registro->idfuncionario ?>, '<?= $registro->palavra_passe ?>', <?= $registro->fk_idstatus ?>)">Registrar</button>
                    ...
                    <i class="fas fa-times" type="button" onclick="fecharElemento(<?= $registro->idfuncionario ?>)"></i>
                  </div>
                </li>
              <?php } ?>
            </ul>
